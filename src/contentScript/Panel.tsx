...
const Panel = () => {
  ...
  const onClickHandle = () => {
    handleRef.current.style.transitionTimingFunction = "ease-in-out";
    handleRef.current.style.transitionDuration = "300ms";
    if (handleRef.current.style.width == PANEL_MIN_WIDTH) {
      handleRef.current.style.minWidth = "0px";
      handleRef.current.style.width = "0px";
      localStorage.setItem("isReload", "0");
      setShowDrag(true);
  ...
  const hideSelect = () => {
    ...
    if (
      selectRef.current.querySelector(".multi-select-content").style.display !=
      "none"
    )
        ...
        >
          ...
          <div style={{ width: "100%" }} onClick={() => hideSelect()}>
            ...
            <div className="sidebar-header">
              <img
                src={getURL("assets/logos/GA4-EventMonitor-Icon-256.png")}
                draggable={false}
              ...
              <img
                onClick={reloadPage}
                src={getURL("assets/logos/refresh.png")}
                className="refresh"
              />
              <img
                className="brush"
                  ...
                  >
                    {cleared ? (
                      <>
                        ...
                        <div style={{ fontWeight: "bold" }}>
                          Please reload the page to display events.
                        </div>
                      </>
                    ) : notFound ? (
                      <>
